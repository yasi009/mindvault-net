    ...
    <section className="py-16 px-6 bg-gradient-subtle">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {audiences.map(({ type, icon: Icon, title, description }) => (
            <Card
              key={type}
              className={cn(
                "group cursor-pointer transition-all duration-300 hover:shadow-elegant",
                audience === type && "ring-2 ring-primary shadow-elegant"
              )}
            ...
            >
              <CardContent className="p-8 text-center">
                <div className={cn(
                  ...
                  audience === type ? "bg-primary text-primary-foreground" : "bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground"
                )}>
