...
export const MyWhy = () => {
  ...
  return <section className="py-20 px-6 bg-gradient-soft">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed font-heading">
            <p>We've always been obsessed with intelligence and with how humans could be better, sharper, more perfect. Whether it was goals, grades, or validation — if it looked good, we got it. But we were miserable.</p>
            ...
            <div className="flex justify-center mt-8">
              <Button onClick={() => navigate('/about-us')} className="bg-primary text-primary-foreground hover:bg-background hover:text-foreground transition-colors duration-300 text-2xl py-6 px-8 font-heading italic">
          ...
          <div className="relative">
            <img src={baliImage} alt="Yaseerah presenting at NIDA workshop on clarity and systems design" className="rounded-lg shadow-lg w-full h-auto object-cover" />
          </div>
        </div>
      </div>
    </section>;
