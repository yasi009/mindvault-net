      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-soft">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 space-y-12">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <p className="text-xl md:text-2xl text-foreground animate-fade-in leading-relaxed">We help l, educators, and leaders cut through overwhelm and build systems that bring clarity, control, and calm to their work and life.</p>
