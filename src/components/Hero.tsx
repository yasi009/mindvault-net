      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-soft">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32 space-y-8 sm:space-y-12">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-6 sm:space-y-8">
            <p className="text-lg sm:text-xl md:text-2xl text-foreground animate-fade-in leading-relaxed px-4">We help L, educators, and leaders cut through overwhelm and build systems that bring clarity, control, and calm to their work and life.</p>
