    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-16 px-6 bg-gradient-to-r from-primary via-purple-100 to-accent overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl font-heading font-bold text-primary max-w-3xl mx-auto leading-relaxed mb-4">
          ...
          <div className="flex justify-center">
            <img 
              ...
              className="w-56 md:w-72 h-auto brightness-0 saturate-[2] opacity-90"
