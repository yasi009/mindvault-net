  ...
  const resources = [
    {
      ...
      description: "A comprehensive Notion template to design your personal operating system. Organize your goals, projects, and daily workflows in one place.",
      category: "Template"
    },
    {
      icon: Lightbulb,
      title: "AI Literacy Checklist",
      description: "Essential guide to understanding and implementing AI in your work. No technical background required.",
      category: "Guide"
    },
    {
      icon: BookOpen,
    ...
    },
    {
      ...
      description: "Step-by-step template to analyze your current processes and identify opportunities for optimization.",
      category: "Template"
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-16 bg-gradient-card p-10 rounded-xl text-center border border-border">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We're constantly creating new guides, case studies, and templates. Sign up for any resource above to be notified when new content becomes available.
            </p>
          </div>
        </div>
      </section>
